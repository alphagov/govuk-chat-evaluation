...
class TestAbsenceOfFactualContradictionsBedrockOpenAI:
    """
    Test the AbsenceOfFactualContradictions metric with real Bedrock API calls.
    ...
    @pytest.mark.asyncio
    async def test_absence_of_factual_contradictions_score_bedrock(
