...
"""
    ...
    @staticmethod
    def generate_verdicts(claims: list[str], ground_truth: list[str]):
...
Claims that are not backed up due to a lack of information/are not mentioned in the retrieval contexts MUST be answered 'idk'.
**
...
{{
    "reason": "The score is <correctness_score> because <your_reason>."
}}
